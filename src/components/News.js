...
export class News extends Component {
    ...
    async updateNews(pageNo) {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=a00766e77a3e4ff284aa6defa6fb4875&page=${this.state.page}&pageSize=${this.props.pageSize}`;
